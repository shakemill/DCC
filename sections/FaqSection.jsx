...
export const FaqSection = () => {
    ...
    return (
        <div className="relative max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            ...
            <SectionTitle text1="FAQ's" text2="Frequently asked questions" text3=" Browse through these FAQs to find answers to commonly asked questions." />
            <div className="mt-8">
                {faqsData.map((faq, index) => (
                    <div className="border-b border-slate-300 dark:border-[#b87718] py-4 cursor-pointer w-full" key={index} onClick={() => setOpenIndex(openIndex === index ? null : index)}>
